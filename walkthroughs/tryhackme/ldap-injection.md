...
```shell-session
user@tryhackme$ ldapsearch -x -H ldap://10.10.113.26:389 -b "dc=ldap,dc=thm" "(ou=People)"
# extended LDIF
#
# LDAPv3
...
<figure><img src="https://tryhackme-images.s3.amazonaws.com/user-uploads/645b19f5d5848d004ab9c9e2/room-content/5813e9f3ac2fdcc629ec1b047a75cee1.png" alt=""><figcaption></figcaption></figure>
...
To demonstrate a simple LDAP Injection attack, go to [http://10.10.113.26/normal.php](http://10.10.113.26/normal.php). Based on the code above, the application constructs an LDAP query for authentication based on user input without proper sanitisation.
...
<figure><img src="https://tryhackme-images.s3.amazonaws.com/user-uploads/645b19f5d5848d004ab9c9e2/room-content/8fc230d9a07a8adaa3fda06498fdf9dd.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://tryhackme-images.s3.amazonaws.com/user-uploads/645b19f5d5848d004ab9c9e2/room-content/20b2a4f30e7b3880a934196393926ed3.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://tryhackme-images.s3.amazonaws.com/user-uploads/645b19f5d5848d004ab9c9e2/room-content/3c98354e63406ae68366efa5d1dcf291.png" alt=""><figcaption></figcaption></figure>
...
For example, below is the code snippet of [http://10.10.113.26/blind.php](http://10.10.113.26/blind.php) that uses an LDAP query to check for the existence of a user but only returns a generic error message on failure. The application also checks if the submitted email is the same as the email in the database:
...
# Base URL
url = 'http://10.10.113.26/blind.php'
...
Use the final payload to log in to [http://10.10.113.26/login.php](http://10.10.113.26/login.php). Make sure to use `*` as the password; this will automatically evaluate the search query as true.
...
<figure><img src="https://tryhackme-images.s3.amazonaws.com/user-uploads/645b19f5d5848d004ab9c9e2/room-content/13f3c3703d5bc9d94a7c60d0c657c598.png" alt=""><figcaption></figcaption></figure>
