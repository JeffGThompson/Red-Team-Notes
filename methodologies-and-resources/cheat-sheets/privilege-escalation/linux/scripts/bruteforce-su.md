...
Used in [spring.md](../../../../../walkthroughs/tryhackme/spring.md "mention") just replace password variable with whatever you're trying to bruteforce
...
Example of how to make your wordlist for the keyword variable above
